...
(function() {
  var add_actions, cell, cellid, config, configdir, configfile, control, data, defaultprojection, e, effects, errors, ex, exinfile, exoutfile, fs, get_marker, i, j, k, l, len, len1, len2, len3, len4, m, marker, mc, mcs, n, name, o, p, path, prefix, prefixes, r, readrow, ref, ref1, ref2, ref3, ref4, ref5, relpath, set_stage, sheet, stage, stages, suffix, w, weathers, wi, workbook, xlfile, xlsx, yaml;
  ...
  add_actions = function(control, prefix, data) {
    var k, len2, msg, msgs, nextstage, ref6;
    ...
    if (data[prefix + 'cue'] != null) {
      ...
      if ((ref6 = !stages[nextstage]) != null ? ref6 : console.log('ERROR: stage ' + data.stage + ' ' + prefix + ' cue to unknown stage: ' + nextstage)) {
