...
(function() {
  var add_actions, cell, cellid, config, configdir, configfile, content_url, control, cuesingle, data, defaultprojection, e, effects, errors, ex, exinfile, exoutfile, fragment, fragments, fs, getCodeIds, get_marker, i, id, ids, j, k, l, label, labels, len, len1, len2, len3, len4, len5, len6, len7, m, marker, mc, mcs, meiids, n, name, o, p, path, prefix, prefixes, q, r, readmeiids, readrow, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, relpath, s, set_stage, sheet, stage, stages, suffix, t, w, weathers, wi, workbook, xlfile, xlsx, yaml;
  ...
  for (r = m = 1; m <= 1000; r = ++m) {
    ...
    for (n = 0, len3 = mcs.length; n < len3; n++) {
      ...
      if ((data[mc] != null) && data[mc] !== '') {
        ...
        fragments = [];
        for (o = 0, len4 = labels.length; o < len4; o++) {
          label = labels[o];
          if (label !== '') {
            if ((label.indexOf('#')) === 0) {
              ...
              if (ids == null) {
                ...
                for (q = 0, len5 = ids.length; q < len5; q++) {
                  id = ids[q];
                  fragments.push('#' + id);
                }
              }
        ...
        for (s = 0, len6 = fragments.length; s < len6; s++) {
  ...
  for (stage in stages) {
    data = stages[stage];
    for (t = 0, len7 = prefixes.length; t < len7; t++) {
      prefix = prefixes[t];
