  ...
  add_actions = function(control, prefix, data, meldload) {
    ...
    if (data[prefix + 'delay'] != null) {
      try {
        ...
        err = error;
        return console.log('ERROR: adding delay of ' + data[prefix + 'delay'] + ' (vdelta ' + data[prefix + 'vdelta'] + ') for ' + data.stage + ' ' + prefix + ' (' + err.message + ')');
      }
    } else {
      add_delayed_visual(control, prefix, data, meldload);
      return add_delayed_midi(control, prefix, data, meldload);
    }
  };
