...
(function() {
  ...
  add_immediate_actions = function(control, prefix, data, meldload) {
    var altstage, channel, l, len2, len3, m, meldprefix, msg, msgs, nextexp, nextstage, nextstages, nexturi, ns, o, q, ref11, ref12, ref13, sfbi, sfi, stageflags, stagetest;
    control.actions.push({
      channel: '',
