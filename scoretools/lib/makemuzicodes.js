      ...
      for (u = 0, len4 = notes.length; u < len4; u++) {
        ...
        if (midi === pmidis[pix]) {
          ...
          if (data[mc + 'cue']) {
            ...
            color = '#00a';
          } else if (data[mc + 'app'] || data[mc + 'v.mc']) {
            color = '#080';
          }
