...
(function() {
  var add_actions, cell, cellid, climbview, config, configdir, configfile, content_url, control, cuesingle, data, defaultprojection, e, effects, errors, ex, exinfile, exoutfile, fragment, fragments, fs, getCodeIds, get_marker, i, id, ids, j, k, l, label, labels, len, len1, len2, len3, len4, len5, len6, len7, m, marker, maxdelay, mc, mcs, meiids, mindelay, name, o, p, path, prefix, prefixes, q, r, readmeiids, readrow, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, relpath, s, set_stage, sheet, stage, stages, suffix, sweathers, t, u, viewconfig, viewgen, viewoutfile, w, weather_urls, weatherdelay, weathers, wi, workbook, xlfile, xlsx, yaml;
  ...
  mindelay = Number((ref8 = config.weatherdelaymin) != null ? ref8 : 0);

  maxdelay = Number((ref9 = config.weatherdelaymax) != null ? ref9 : 0);
  ...
  add_actions = function(control, prefix, data, meldload) {
    var channel, k, l, len2, len3, meldprefix, msg, msgs, nextstage, ref10, ref11;
    control.actions.push({
      channel: '',
      url: content_url(data[prefix + 'monitor'])
    });
    ref10 = ['v.background', 'v.animate', 'v.mc'];
    ...
    if (data[prefix + 'cue'] != null) {
      ...
      if ((ref11 = !stages[nextstage]) != null ? ref11 : console.log('ERROR: stage ' + data.stage + ' ' + prefix + ' cue to unknown stage: ' + nextstage)) {
    ...
    for (wi = k = 0, len2 = weathers.length; k < len2; wi = ++k) {
      ...
      if ((data[w + '_effect'] != null) && data[w + '_effect'].length > 0) {
        if (data[w + '_effect'].substring(0, 1).toLowerCase() === 'y') {
          ...
          if (!(isNaN(n)) && n > 0) {
            for (ni = l = 1, ref10 = n; 1 <= ref10 ? l <= ref10 : l >= ref10; ni = 1 <= ref10 ? ++l : --l) {
              ws.push(wi);
            }
          }
        }
  ...
  get_marker = function(ex, markertitle, optdescription) {
    var markers, ref10;
    markers = (ref10 = (function() {
      var k, len2, ref11, results;
      ref11 = ex.markers;
      results = [];
