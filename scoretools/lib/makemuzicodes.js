...
(function() {
  var add_actions, add_delayed_actions, add_immediate_actions, cell, cellid, climbview, codetitles, config, configdir, configfile, content_url, control, ct, cuesingle, data, defaultprojection, delayid, e, effects, errors, ex, exinfile, exoutfile, fragment, fragments, fs, getCodeIds, get_marker, guid, i, id, ids, j, k, l, label, labels, len, len1, len2, len3, len4, len5, len6, len7, len8, m, marker, markernames, maxdelay, maxrow, mc, mcs, meiids, mi, mindelay, name, o, p, path, prefix, prefixes, q, r, readmeiids, readrow, ref, ref1, ref10, ref11, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, relpath, s, set_stage, sheet, stage, stages, sweathers, t, title, u, v, viewconfig, viewgen, viewoutfile, w, weather_urls, weatherdelay, weathers, wi, workbook, xlfile, xlsx, yaml;
  ...
  for (r = m = 1; m <= 1000; r = ++m) {
    ...
    codetitles = {};
    for (mi = o = 0, len3 = mcs.length; o < len3; mi = ++o) {
      mc = mcs[mi];
      if (!data[mc + 'name']) {
        continue;
      }
      ...
      if (codetitles[marker.title] === void 0) {
        ...
        ref11 = codetitles[marker.title];
        for (q = 0, len4 = ref11.length; q < len4; q++) {
          ct = ref11[q];
      ...
      if ((data[mc] != null) && data[mc] !== '') {
        ...
        fragments = [];
        for (s = 0, len5 = labels.length; s < len5; s++) {
          label = labels[s];
          if (label !== '') {
            if ((label.indexOf('#')) === 0) {
              ...
              if (ids == null) {
                ...
                for (t = 0, len6 = ids.length; t < len6; t++) {
                  id = ids[t];
                  fragments.push('#' + id);
                }
              }
        ...
        for (u = 0, len7 = fragments.length; u < len7; u++) {
          fragment = fragments[u];
          marker.actions.push({
            url: '{{meldcollection}}',
            post: true,
            contentType: 'application/json',
  ...
  for (stage in stages) {
    data = stages[stage];
    for (v = 0, len8 = prefixes.length; v < len8; v++) {
      prefix = prefixes[v];
