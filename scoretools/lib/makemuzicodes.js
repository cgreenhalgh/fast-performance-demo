...
(function() {
  var add_actions, cell, cellid, config, configdir, configfile, control, data, defaultprojection, e, effects, errors, ex, exinfile, exoutfile, fs, get_marker, i, j, k, l, len, len1, len2, len3, len4, m, marker, mc, mcs, n, name, p, path, prefix, prefixes, r, readrow, ref, ref1, ref2, ref3, ref4, ref5, relpath, set_stage, sheet, stage, stages, suffix, w, weathers, wi, workbook, xlfile, xlsx, yaml;
  ...
  for (stage in stages) {
    data = stages[stage];
    for (n = 0, len4 = prefixes.length; n < len4; n++) {
      prefix = prefixes[n];
