...
(function() {
  ...
  processmeifile = function(meifile, data, meiids) {
    var fragments, len3, len4, mc, mei, meiout, meitext, mi, midi, nmidis, note, notes, pix, pmidis, pnotes, t, u;
  ...
  for (r = t = 1; t <= 1000; r = ++t) {
    ...
    if (data._index === 0) {
      ...
      for (sfi = u = 1, ref12 = numflagvars; 1 <= ref12 ? u <= ref12 : u >= ref12; sfi = 1 <= ref12 ? ++u : --u) {
    ...
    for (mi = x = 0, len3 = mcs.length; x < len3; mi = ++x) {
      ...
      if (codetitles[marker.title] === void 0) {
        ...
        for (y = 0, len4 = ref13.length; y < len4; y++) {
          ct = ref13[y];
  ...
  for (sfi = k1 = 1, ref14 = numflagvars; 1 <= ref14 ? k1 <= ref14 : k1 >= ref14; sfi = 1 <= ref14 ? ++k1 : --k1) {
  ...
  for (l1 = 0, len8 = ref15.length; l1 < len8; l1++) {
    channel = ref15[l1];
  ...
  ref16 = ex.markers;
  for (m1 = 0, len9 = ref16.length; m1 < len9; m1++) {
    marker = ref16[m1];
