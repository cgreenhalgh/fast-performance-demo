...
(function() {
  var add_actions, cell, cellid, config, configdir, configfile, content_url, control, cuesingle, data, defaultprojection, e, effects, errors, ex, exinfile, exoutfile, fs, get_marker, i, j, k, l, len, len1, len2, len3, len4, m, marker, mc, mcs, n, name, o, p, path, prefix, prefixes, r, readrow, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, relpath, set_stage, sheet, stage, stages, suffix, w, weathers, wi, workbook, xlfile, xlsx, yaml;
