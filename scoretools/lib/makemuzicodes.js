...
(function() {
  var add_actions, cell, cellid, config, configdir, configfile, control, cuesingle, data, defaultprojection, e, effects, errors, ex, exinfile, exoutfile, fs, get_marker, i, j, k, l, len, len1, len2, len3, len4, m, marker, mc, mcs, n, name, o, p, path, prefix, prefixes, r, readrow, ref, ref1, ref2, ref3, ref4, ref5, ref6, relpath, set_stage, sheet, stage, stages, suffix, w, weathers, wi, workbook, xlfile, xlsx, yaml;
  ...
  cuesingle = (ref6 = config.cuesingle) != null ? ref6 : false;
  ...
  add_actions = function(control, prefix, data, meldload) {
    var k, len2, meldprefix, msg, msgs, nextstage, ref7;
    ...
    if (data[prefix + 'cue'] != null) {
      ...
      if ((ref7 = !stages[nextstage]) != null ? ref7 : console.log('ERROR: stage ' + data.stage + ' ' + prefix + ' cue to unknown stage: ' + nextstage)) {
  ...
  get_marker = function(ex, markertitle, optdescription) {
    var markers, ref7;
    markers = (ref7 = (function() {
      var k, len2, ref8, results;
      ref8 = ex.markers;
      results = [];
