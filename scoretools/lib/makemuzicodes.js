...
(function() {
  var add_actions, cell, cellid, climbview, config, configdir, configfile, content_url, control, cuesingle, data, defaultprojection, e, effects, errors, ex, exinfile, exoutfile, fragment, fragments, fs, getCodeIds, get_marker, i, id, ids, j, k, l, label, labels, len, len1, len2, len3, len4, len5, len6, len7, m, marker, mc, mcs, meiids, name, o, p, path, prefix, prefixes, q, r, readmeiids, readrow, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, relpath, s, set_stage, sheet, stage, stages, suffix, t, u, viewconfig, viewgen, viewoutfile, w, weather_urls, weathers, wi, workbook, xlfile, xlsx, yaml;
  ...
  add_actions = function(control, prefix, data, meldload) {
    var channel, k, l, len2, len3, meldprefix, msg, msgs, nextstage, ref8, ref9;
    control.actions.push({
      channel: '',
      url: content_url(data[prefix + 'monitor'])
    });
    ref8 = ['v.background', 'v.animate', 'v.mc'];
      ...
      if (data[prefix + channel] != null) {
        if (channel === 'v.mc' && String(data[prefix + channel]) === '1') {
          if (config.defaultmuzicodeurl != null) {
            ...
            console.log('warning: use of undefined defaultmuzicodeurl in ' + prefix + channel);
          }
        } else {
    ...
    if (data[prefix + 'cue'] != null) {
      ...
      if ((ref9 = !stages[nextstage]) != null ? ref9 : console.log('ERROR: stage ' + data.stage + ' ' + prefix + ' cue to unknown stage: ' + nextstage)) {
