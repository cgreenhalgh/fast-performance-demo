...
(function() {
  var BITS_PER_FLAGVAR, add_actions, add_delayed_mc, add_delayed_midi, add_delayed_visual, add_immediate_actions, cell, cellid, challengecount, channel, climbview, codetitles, config, configdir, configfile, content_url, control, ct, cuesingle, data, defaultprojection, delayid, e, effects, errors, ex, exinfile, exoutfile, fragment, fragments, fs, getCodeIds, get_marker, getfragmentids, guid, i, i1, j, j1, k, k1, l, l1, len, len1, len10, len11, len2, len3, len4, len5, len6, len7, len8, len9, m1, marker, markernames, maxdelay, maxrow, mc, mcs, mei, meicolorapp, meicolorcue, meicolormidi, meicolorother, meiids, meitext, meiutils, meldmc, meldout, meldoutfile, meldstage, mi, midi, mindelay, n1, nextexp, nextstage, nextstages, nexturi, nmidis, note, notes, numflagvars, numstages, o, o1, p, path, pix, pmidis, pnotes, prefix, prefixes, processmeifile, q, r, readmeifile, readmeiids, readrow, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref19, ref2, ref20, ref21, ref22, ref3, ref4, ref5, ref6, ref7, ref8, ref9, relpath, set_stage, sfi, sheet, stage, stages, sweathers, t, title, u, unused, v, viewconfig, viewgen, viewoutfile, w, weather_urls, weatherdelay, weathers, wi, workbook, writemeifile, x, xlfile, xlsx, y, yaml, z;
  ...
  for (r = t = 1; t <= 1000; r = ++t) {
    ...
    if (challengecount > 1) {
      ref18 = meldstage.mcs;
      for (j1 = 0, len7 = ref18.length; j1 < len7; j1++) {
        meldmc = ref18[j1];
        meldmc.type = 'choice';
      }
    }
  ...
  for (sfi = m1 = 1, ref19 = numflagvars; 1 <= ref19 ? m1 <= ref19 : m1 >= ref19; sfi = 1 <= ref19 ? ++m1 : --m1) {
  ...
  ref20 = ['v.animate', 'v.mc', 'v.background', 'v.weather'];
  for (n1 = 0, len10 = ref20.length; n1 < len10; n1++) {
    channel = ref20[n1];
  ...
  ref21 = ex.markers;
  for (o1 = 0, len11 = ref21.length; o1 < len11; o1++) {
    marker = ref21[o1];
    if (marker.precondition === '' && marker.actions.length === 0) {
      unused = true;
      ref22 = marker.poststate;
      for (k in ref22) {
        v = ref22[k];
        unused = false;
        break;
