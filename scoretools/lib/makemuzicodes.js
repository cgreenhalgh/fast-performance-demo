...
(function() {
  var BITS_PER_FLAGVAR, add_actions, add_delayed_actions, add_immediate_actions, cell, cellid, climbview, codetitles, config, configdir, configfile, content_url, control, ct, cuesingle, data, defaultprojection, delayid, e, effects, errors, ex, exinfile, exoutfile, fragment, fragments, fs, getCodeIds, get_marker, guid, i, i1, id, ids, j, j1, k, k1, l, label, labels, len, len1, len2, len3, len4, len5, len6, len7, len8, len9, m, marker, markernames, maxdelay, maxrow, mc, mcs, meiids, mi, mindelay, name, numflagvars, numstages, o, p, path, prefix, prefixes, q, r, readmeiids, readrow, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, relpath, s, set_stage, sfi, sheet, stage, stages, sweathers, t, title, u, unused, v, viewconfig, viewgen, viewoutfile, w, weather_urls, weatherdelay, weathers, wi, workbook, x, xlfile, xlsx, y, yaml, z;
  ...
  add_delayed_actions = function(control, prefix, data, meldload) {
    var channel, l, len2, len3, m, msg, msgs, ref11, results;
    ref11 = ['v.animate'];
    for (l = 0, len2 = ref11.length; l < len2; l++) {
      channel = ref11[l];
      if (data[prefix + channel] != null) {
