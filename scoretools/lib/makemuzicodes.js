...
(function() {
  var BITS_PER_FLAGVAR, add_actions, add_delayed_mc, add_delayed_midi, add_delayed_visual, add_immediate_actions, cell, cellid, channel, climbview, codetitles, config, configdir, configfile, content_url, control, ct, cuesingle, data, defaultprojection, delayid, e, effects, errors, ex, exinfile, exoutfile, fragment, fragments, fs, getCodeIds, get_marker, getfragmentids, guid, i, i1, j, j1, k, k1, l, l1, len, len1, len2, len3, len4, len5, len6, len7, len8, len9, m1, marker, markernames, maxdelay, maxrow, mc, mcs, meicolorapp, meicolorcue, meicolormidi, meicolorother, meiids, meiutils, meldmc, meldout, meldoutfile, meldstage, mi, mindelay, nextexp, nextstage, nextstages, nexturi, numflagvars, numstages, o, p, path, prefix, prefixes, processmeifile, q, r, readmeifile, readmeiids, readrow, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref19, ref2, ref20, ref21, ref3, ref4, ref5, ref6, ref7, ref8, ref9, relpath, set_stage, sfi, sheet, stage, stages, sweathers, t, title, u, unused, v, viewconfig, viewgen, viewoutfile, w, weather_urls, weatherdelay, weathers, wi, workbook, writemeifile, x, xlfile, xlsx, y, yaml, z;
  ...
  add_immediate_actions = function(control, prefix, data, meldload) {
    var channel, l, len2, len3, len4, msg, msgs, nextstage, nextstages, ns, o, q, ref11, ref12, ref13, sfbi, sfi, stageflags, stagetest, t, text, u;
    control.actions.push({
      channel: '',
      url: content_url(data[prefix + 'monitor'])
    });
    ref11 = ['v.background', 'v.mc'];
    ...
    if (data[prefix + 'cue'] != null) {
      ...
      for (q = 0, len4 = nextstages.length; q < len4; q++) {
        ...
        if ((nextstage != null) && (data.next != null) && (stages[nextstage] != null) && (stages[data.next] != null) && nextstage !== data.next) {
          stageflags = [];
          for (sfi = t = 1, ref12 = numflagvars; 1 <= ref12 ? t <= ref12 : t >= ref12; sfi = 1 <= ref12 ? ++t : --t) {
            stageflags[sfi - 1] = 0;
          }
          ns = nextstage;
          ...
          stagetest = '';
          for (sfi = u = 1, ref13 = numflagvars; 1 <= ref13 ? u <= ref13 : u >= ref13; sfi = 1 <= ref13 ? ++u : --u) {
  ...
  set_stage = function(control, data) {
    var l, len2, n, ni, o, ref11, sfbi, sfi, ws;
    if (control.poststate == null) {
      control.poststate = {};
    }
    ...
    for (wi = l = 0, len2 = weathers.length; l < len2; wi = ++l) {
      ...
      if ((data[w + '_effect'] != null) && data[w + '_effect'].length > 0) {
        if (data[w + '_effect'].substring(0, 1).toLowerCase() === 'y') {
          ...
          if (!(isNaN(n)) && n > 0) {
            for (ni = o = 1, ref11 = n; 1 <= ref11 ? o <= ref11 : o >= ref11; ni = 1 <= ref11 ? ++o : --o) {
              ws.push(wi);
            }
          }
        }
  ...
  for (sfi = q = 1, ref11 = numflagvars; 1 <= ref11 ? q <= ref11 : q >= ref11; sfi = 1 <= ref11 ? ++q : --q) {
  ...
  meicolorcue = (ref12 = config.meicolorcue) != null ? ref12 : '#c00';

  meicolormidi = (ref13 = config.meicolormidi) != null ? ref13 : '#00d';

  meicolorapp = (ref14 = config.meicolorapp) != null ? ref14 : '#080';

  meicolorother = (ref15 = config.meicolorother) != null ? ref15 : '#666';
  ...
  for (r = t = 1; t <= 1000; r = ++t) {
    ...
    if (data._index === 0) {
      ...
      for (sfi = u = 1, ref16 = numflagvars; 1 <= ref16 ? u <= ref16 : u >= ref16; sfi = 1 <= ref16 ? ++u : --u) {
    ...
    for (mi = x = 0, len3 = mcs.length; x < len3; mi = ++x) {
      ...
      if (codetitles[marker.title] === void 0) {
        ...
        ref17 = codetitles[marker.title];
        for (y = 0, len4 = ref17.length; y < len4; y++) {
          ct = ref17[y];
  ...
  for (stage in stages) {
    data = stages[stage];
    for (i1 = 0, len6 = prefixes.length; i1 < len6; i1++) {
      prefix = prefixes[i1];
      if (data[prefix + 'cue'] != null) {
        nextstages = ((data[prefix + 'cue'].split('/')).map((function(_this) {
          return function(s) {
        ...
        for (j1 = 0, len7 = nextstages.length; j1 < len7; j1++) {
          nextstage = nextstages[j1];
  ...
  for (sfi = k1 = 1, ref18 = numflagvars; 1 <= ref18 ? k1 <= ref18 : k1 >= ref18; sfi = 1 <= ref18 ? ++k1 : --k1) {
  ...
  ref19 = ['v.animate', 'v.mc', 'v.background', 'v.weather'];
  for (l1 = 0, len8 = ref19.length; l1 < len8; l1++) {
    channel = ref19[l1];
  ...
  ref20 = ex.markers;
  for (m1 = 0, len9 = ref20.length; m1 < len9; m1++) {
    marker = ref20[m1];
    if (marker.precondition === '' && marker.actions.length === 0) {
      unused = true;
      ref21 = marker.poststate;
      for (k in ref21) {
        v = ref21[k];
        unused = false;
        break;
